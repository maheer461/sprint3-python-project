...
# a) Extract "Pokemon" from the 5th game (index 4)
game_name = video_game_sales[4][NAME]  # 'Pokemon Red/Blue'
pokemon_only = game_name[:7]  # Extract first 7 characters 'Pokemon'
print(pokemon_only)
...
# c) Format summary of the #1 game
