...
# a) Create a list containing only the names of all 20 games
game_names = []
...
# Explanation: A tuple is more appropriate than a list for this data because:
# Metadata like dataset dimensions and name should not change accidentally.
# Tuples are immutable, meaning once created, their contents cannot be modified,
# which makes them perfect for storing fixed, read-only information.
