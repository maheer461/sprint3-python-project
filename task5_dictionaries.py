...
# a) Create dictionary of total global sales by genre
sales_by_genre = {}
...
print("Number of games per publisher:")
print(games_per_publisher)
print()

# c) Create dictionary for the #1 ranked game and print its details
top_game = {
...
print("Details of the #1 ranked game:")
